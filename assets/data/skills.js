        ...
        ed: [
            {
                ...
                image: '/photos/certificates/bit.png',
                details: [
                    "Completed an intensive 880-hour web development program, focused on front-end technologies: HTML, CSS, JavaScript, and React for building dynamic user interfaces, gained experience in back-end development using Node.js and Express, learned to integrate MySQL databases and develop RESTful APIs, understood the full-stack development lifecycle and web application deployment processes."
                ],
            },
            {
                ...
                image: '/photos/certificates/three.png',
                details: [
                    "Acquired skills in 3D web development using the Three.js library, gained practical experience with React Three Fiber (R3F) and related libraries (Drei, postprocessing).",
                ],
            },
        ]
    }
